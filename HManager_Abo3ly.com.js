...
// @namespace   @nas272
// @include     http://192.168.8.1/html/content.html#home
// @version     2.0
...
var dump = '<div class="draggable"> 	<iframe src="http://192.168.8.1/api/device/signal" id="iframe_id" style="border:2px solid red;display: none;" title="ipa"></iframe>		<table style="width: 100%;" id="table"dir="rtl" border="0"></td><td colspan="4"  dir="ltr" style="height: 23px;"><bt><button onclick="about()" id="about" style="position:absolute;left:0;top:0;height: 25px;width: 25px;" >؟</button><span id="netmode"></span><span id="band"></span><span>تم التطور من مشعل العنزي</span></td></tr><tr> 				<td id="t21" class="label">رقم الخلية</td><td><span id="cell_id">0</span></td><td id="t23" class="label">PCI</td><td><span id="pci">0</span></td> 				</tr> 				<tr> 				<td id="t31" class="label">RSSI</td><td><span id="rssi">0</span></td><td id="t33" class="label">SINR</td><td><span id="sinr">0</span></td> 				</tr> 				<tr id="rsrqtr"> 				<td id="t311" class="label">RSRQ</td><td id="rsrq">0</td><td id="t322" class="label">RSRP</td><td><span id="rsrp">0</span></td> 				</tr> 				 				<tr id="txpowertr"> 				<td id="t61" class="label">txpower</td><td id="txpower" colspan="3" dir="ltr">0</td> 				</tr> 				<tr> 				<td id="t21" class="label">RSRQ_5G</td><td><span id="nrrsrq" dir="ltr">0</span></td><td id="t23" class="label">SINR_5G</td><td><span id="nrsinr" dir="ltr">0</span></td> 				</tr> 				<tr> 				<td id="t61" class="label">RSRP_5G</td><td colspan="3" id="nrrsrp">-</td></td> 				</tr> 			</table> 			</div>';
